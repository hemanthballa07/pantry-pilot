// Port of src/data.js — Hemanth's student apartment kitchen.
// Legacy attaches PP_DATA to window; here we export `mock` and rely on
// `satisfies PPData` to keep the literal honest. Every key preserved.

import type { PPData } from '@/types';
...
export const mock = {
  ...
  recipes: [
    {
      ...
      diet: ['Vegetarian', 'High-protein-add'],
    ...
    },
    {
      ...
      difficulty: 'Medium',
      match: 55,
      missing: ['Paneer', 'Butter', 'Cream', 'Garam masala'],
    ...
    },
    {
      ...
      difficulty: 'Easy',
      match: 70,
      missing: ['Red lentils', 'Cumin seeds'],
    ...
    },
    {
      ...
      difficulty: 'Easy',
      match: 75,
      missing: ['Chicken stock', 'Cornstarch'],
  ...
  mealPlan: {
    Mon: { B: 'r5', L: 'r3', D: 'r1' },
    Tue: { B: 'r7', L: null, D: 'r2' }, // leftover fried rice
    Wed: { B: 'r6', L: 'r3', D: 'r4' },
  ...
  grocery: [
    {
      ...
      section: 'Produce',
      price: 1.49,
      needed: ['Schezwan Egg Fried Rice'],
      addedBy: 'Pilot',
      priority: 'high',
      bought: false,
    },
  ...
  pilotSuggestions: [
    {
      ...
      body: 'Pair with eggs and rice for fried rice tonight — uses 3 fading ingredients.',
    },
    {
      id: 'p2',
      icon: 'leaf',
      tone: 'green',
      title: 'Cook 5 meals without shopping',
      body: 'You have everything for chickpea bowl, tofu stir-fry, omelette, parfait, and pancakes.',
    },
    {
      id: 'p3',
      icon: 'wallet',
      tone: 'amber',
      title: '$42 saved this week',
      body: "Cooking 4 pantry-based meals instead of takeout. You're $66 under budget.",
    },
    {
      id: 'p4',
      icon: 'alert',
      tone: 'orange',
      title: 'You buy milk every 6 days',
      body: 'Switching to a half-gallon size could reduce waste — you tossed milk twice last month.',
    },
  ],
  ...
  activity: [
    ...
    { when: '1h ago', who: 'Alex', action: 'added Whole Milk to grocery list', icon: 'cart' },
    {
      when: '3h ago',
      who: 'Hemanth',
      action: 'cooked Chickpea Rice Bowl · 2 servings',
      icon: 'chef',
    },
  ...
  leftovers: [
    {
      id: 'l1',
      meal: 'Cooked Jasmine Rice',
      servings: 2,
      cooked: 'Mon',
      useBy: 'Wed',
      days: 1,
      tone: 'amber',
      storage: 'Fridge · sealed glass',
      reheat: 'Microwave 90 sec with a splash of water, or stir-fry over high heat.',
      illo: 'rice',
      remix: ['Schezwan Fried Rice', 'Egg Rice Bowl', 'Rice Soup'],
    },
    {
      id: 'l2',
      meal: 'Chickpea Rice Bowl',
      servings: 1,
      cooked: 'Today',
      useBy: 'Thu',
      days: 3,
  ...
  budget: {
    ...
    savedFromPantry: 42,
    byCategory: [
      { cat: 'Produce', amount: 38.4, color: '#3B6E3D' },
      { cat: 'Dairy', amount: 42.1, color: '#C99325' },
      { cat: 'Meat', amount: 31.8, color: '#C73E2E' },
      { cat: 'Grains', amount: 22.5, color: '#B85C1F' },
      { cat: 'Frozen', amount: 18.2, color: '#3A5F7A' },
      { cat: 'Snacks', amount: 14.62, color: '#6E3A4F' },
      { cat: 'Sauces', amount: 9.8, color: '#D9722B' },
      { cat: 'Household', amount: 6.9, color: '#6F665A' },
    ],
  ...
  todayPlan: {
    ...
    slots: [
      ...
      },
      {
        slot: 'L',
        time: '12:30 pm',
        name: 'Leftover Chickpea Bowl',
        recipe: null,
        kind: 'Reheat · 0 effort',
        uses: ['Chickpea Rice Bowl'],
        cal: 460,
        p: 18,
        status: 'leftover',
        tone: '#C99325',
  ...
  // ─── Kitchen Wins (achievements) ─────────────────────────────
  kitchenWins: [
    {
      id: 'w1',
      title: 'No-waste week',
      value: '7 days',
      sub: 'Nothing tossed since Nov 18',
      icon: 'leaf',
      tone: 'green',
    },
    {
    ...
    },
    {
      ...
      title: 'Under budget',
      value: '$66 left',
      sub: '8 days remaining in November',
      icon: 'wallet',
      tone: 'green',
    },
    {
      id: 'w4',
      title: 'Saved vs. takeout',
      value: '$84',
      sub: 'by cooking pantry meals',
      icon: 'sparkles',
      tone: 'amber',
    },
  ],
  ...
  // Note: 'Olive Oil' appears twice in have[]. Mirroring legacy intentionally;
  // see PROJECT_LOG OQ-008 for the cleanup decision.
  staples: {
    score: 76,
    have: [
      'Jasmine Rice',
  ...
  unlocks: [
    {
      ...
      unlocks: 4,
      price: 2.99,
      meals: ['Breakfast Wrap', 'Air Fryer Chicken Wrap', 'Quesadilla', 'Bean Burrito'],
      tone: '#D9722B',
    },
    {
      id: 'u2',
      ...
      unlocks: 5,
      price: 1.49,
      meals: ['Pasta Pomodoro', 'Tomato Soup', 'Chicken Curry', 'Shakshuka', 'Tomato Rice'],
      tone: '#C73E2E',
    },
    {
      id: 'u3',
      ...
      unlocks: 3,
      price: 5.49,
      meals: ['Spinach Pasta', 'Cacio e Pepe', 'Risotto'],
      tone: '#C99325',
    },
    {
      id: 'u4',
      ...
      unlocks: 4,
      price: 3.99,
      meals: ['Carbonara', 'Creamy Soup', 'Pasta Alfredo', 'Vodka Sauce'],
      tone: '#6E3A4F',
    },
    {
      id: 'u5',
      ...
      unlocks: 3,
      price: 2.4,
      meals: ['Black Bean Bowl', 'Citrus Slaw', 'Pad Thai'],
      tone: '#3B6E3D',
    },
  ],
  ...
  wasteRescue: {
    ...
    plan: [
      {
        day: 'Today',
        action: 'Use cooked rice + spinach',
        recipe: 'r1',
        value: 5.49,
        illos: ['rice', 'spinach'],
        why: 'Both expire by tomorrow',
      },
      {
        day: 'Tomorrow',
        action: 'Pasta with last spinach + bread side',
        recipe: 'r2',
        value: 4.2,
        illos: ['spinach', 'bread'],
        why: 'Pasta uses the rest of the spinach',
      },
      {
        day: 'Friday',
        action: 'Cook chicken now or freeze it',
        recipe: 'r4',
        value: 7.99,
        illos: ['chicken'],
        why: 'Chicken expires Friday',
      },
    ],
  },
  ...
  takeoutSwaps: [
    ...
    {
      id: 'ts2',
      takeout: 'Chicken Wrap',
      takeoutCost: 12.5,
      home: 'Air Fryer Chicken Wrap',
      homeCost: 3.1,
      time: 20,
      save: 9.4,
      recipe: 'r4',
  ...
  occasions: [
    ...
    {
      id: 'o3',
      name: 'Friends coming over',
      icon: 'users',
      desc: 'Dinner for 4, scales easily',
      meals: 1,
      hours: 1.0,
      cost: 26,
    },
  ...
  inbox: [
    ...
    { id: 'in2', type: 'grocery', text: 'Buy oat milk this weekend', when: '2h ago' },
    {
      id: 'in3',
      type: 'voice',
      text: "Voice note · 0:14 · 'try Schezwan paneer'",
      when: 'yesterday',
    },
    {
      id: 'in4',
      type: 'photo',
      text: 'Photo · fridge condition before grocery run',
      when: 'yesterday',
    },
  ...
  notebook: [
    {
      ...
      last: '2 weeks ago',
      rating: 5,
      notes: 'Use ghee, not oil',
    },
    {
      id: 'nb2',
      name: "Roommate Alex's stir-fry",
      tone: '#3B6E3D',
      ill: 'frozenveg',
      last: 'Last week',
      rating: 4,
      notes: 'Add extra soy + sesame',
    },
    {
      id: 'nb3',
      name: 'TikTok feta pasta',
      tone: '#C73E2E',
      ill: 'pasta',
      last: 'Never',
      rating: null,
      notes: 'Try when feta is on sale',
    },
    {
      id: 'nb4',
      name: 'Late-night egg rice',
      tone: '#D9722B',
      ill: 'rice',
      last: '3 days ago',
      rating: 5,
      notes: 'Soy + sesame + scallion. Always works.',
    },
  ],
  ...
  reels: [
    {
      ...
      creator: "Mei's Wok",
      handle: 'meiswok',
      title: 'Wok-hei fried rice in 18 min',
      caption: 'The cold-rice trick that makes it taste like takeout 🔥',
      likes: '24.1k',
      saves: '8.3k',
      comments: '612',
      duration: '0:46',
    ...
    },
    {
      id: 'rl2',
      recipeId: 'r16',
      creator: 'Plant Powered Sam',
      handle: 'plantpoweredsam',
      title: 'Tofu so crispy it crunches',
      caption: "Cornstarch + don't touch the pan. That's the whole secret.",
      likes: '41.7k',
      saves: '15.2k',
      comments: '1.1k',
      duration: '0:38',
    ...
    },
    {
      id: 'rl3',
      recipeId: 'r11',
      creator: 'Desi Kitchen',
      handle: 'desikitchen',
      title: 'Restaurant-style chana masala',
      caption: "Brown the onions properly. That's where all the flavour lives.",
      likes: '33.5k',
      saves: '12.9k',
      comments: '884',
      duration: '0:54',
    ...
    },
    {
      ...
      creator: 'Quick Tacos',
      handle: 'quicktacos',
      title: '10-minute taco night',
      caption: 'Smoky black beans + a quick pico = weeknight hero 🌮',
      likes: '18.9k',
      saves: '5.6k',
      comments: '402',
      duration: '0:31',
    ...
    },
    {
      ...
      caption: 'No flour, no sugar. Uses up those sad brown bananas.',
      likes: '52.3k',
      saves: '21.4k',
      comments: '1.6k',
      duration: '0:28',
    ...
    },
    {
      id: 'rl6',
      recipeId: 'r22',
      creator: 'Meal Prep Kitchen',
      handle: 'mealprepkitchen',
      title: '5 burrito bowls, one pan',
      caption: 'Cilantro-lime rice + smoky beans. Lunch sorted all week.',
      likes: '29.0k',
      saves: '11.1k',
      comments: '733',
      duration: '1:02',
