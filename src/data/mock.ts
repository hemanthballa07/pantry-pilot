...
export const mock = {
  ...
  // ─── Recipes ─────────────────────────────────────────────────
  recipes: [
    { id: 'r1',  name: 'Schezwan Egg Fried Rice', time: 18, difficulty: 'Easy',
    ...
    { id: 'r2', name: 'Garlic Butter Spinach Pasta', time: 22, difficulty: 'Easy',
    ...
    { id: 'r3', name: 'Chickpea Rice Bowl', time: 25, difficulty: 'Easy',
      match: 100, missing: [],
    ...
    { id: 'r4', name: 'Air Fryer Chicken Wrap', time: 20, difficulty: 'Easy',
    ...
    { id: 'r5', name: 'Banana Oat Pancakes', time: 15, difficulty: 'Easy',
      match: 100, missing: [],
    ...
    { id: 'r6', name: 'Vegetable Omelette', time: 10, difficulty: 'Easy',
      match: 100, missing: [],
    ...
    { id: 'r7', name: 'Greek Yogurt Parfait', time: 5, difficulty: 'Easy',
      match: 100, missing: [],
    ...
    { id: 'r8', name: 'Tofu Stir Fry', time: 24, difficulty: 'Medium',
      match: 100, missing: [],
    ...
    { id: 'r9', name: 'Egg & Cheese Sandwich', time: 8, difficulty: 'Easy',
      match: 100, missing: [],
    ...
    { id: 'r10', name: 'Spiced Black Bean Bowl', time: 18, difficulty: 'Easy',
    ...
    { id: 'r11', name: 'Chana Masala', time: 28, difficulty: 'Easy',
    ...
    { id: 'r12', name: 'Masala Egg Curry', time: 30, difficulty: 'Medium',
    ...
    { id: 'r13', name: 'Paneer Butter Masala', time: 35, difficulty: 'Medium',
    ...
    { id: 'r14', name: 'Dal Tadka', time: 30, difficulty: 'Easy',
    ...
    { id: 'r15', name: 'Veg Hakka Noodles', time: 22, difficulty: 'Easy',
    ...
    { id: 'r16', name: 'Kung Pao Tofu', time: 26, difficulty: 'Medium',
    ...
    { id: 'r17', name: 'Chicken Chow Mein', time: 25, difficulty: 'Medium',
    ...
    { id: 'r18', name: 'Egg Drop Soup', time: 12, difficulty: 'Easy',
    ...
    { id: 'r19', name: 'Black Bean Tacos', time: 20, difficulty: 'Easy',
    ...
    { id: 'r20', name: 'Chicken Quesadilla', time: 22, difficulty: 'Easy',
    ...
    { id: 'r21', name: 'Huevos Rancheros', time: 18, difficulty: 'Easy',
    ...
    { id: 'r22', name: 'Burrito Bowl', time: 25, difficulty: 'Easy',
      match: 100, missing: [],
